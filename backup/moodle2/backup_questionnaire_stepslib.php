...
class backup_questionnaire_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $questinss = new backup_nested_element('quest_inss');

        $questins = new backup_nested_element('quest_ins', array('id'), array('question_id', 'userid', 'staffid'));
        ...
        $question->add_child($questinss);
        $questchoices->add_child($questins);
        ...
        if (!$haspublic) {
            ...
            $questins->set_source_table('questionnaire_quest_ins', array('question_id' => backup::VAR_PARENTID));
