...
/**
 * This file contains the parent class for instructor rate question types.
 *
...
class insrate extends question {
    ...
    public function question_template() {
        return 'mod_questionnaire/question_insrate';
    }
    ...
    public function response_template() {
        return 'mod_questionnaire/response_insrate';
    }

    /**
     * Return true if insrate scale type is set to "Normal".
     * @param $scaletype
     * @return bool
     */
