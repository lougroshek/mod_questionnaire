...
function xmldb_questionnaire_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2020070100) {
        ...
        // Define table questionnaire quest choice ins to be created.
        $table = new xmldb_table('questionnaire_quest_ins');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('question_id', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, null, null);
        $table->add_field('userid', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, null, null);
        $table->add_field('staffid', XMLDB_TYPE_INTEGER, '18', null, XMLDB_NOTNULL, null, null);

        // Adding keys to table questionnaire_quest choice ins.
        $table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
        ...
        // Add in the value into the instructor type field.
        if (!$DB->get_record('questionnaire_question_type', array('type' => 'Instructor List'))) {
             $questiontype = new stdClass();
             $questiontype->typeid = 11;
             $questiontype->type = 'Instructor List';
        ...
        // Questionnaire savepoint reached.
        upgrade_mod_savepoint(true, 2020070100, 'questionnaire');
    }
